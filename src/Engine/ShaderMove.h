 ...
 */
template<typename Pixel>
inline ShaderMove<Pixel> ShaderSurface(Surface* s)
{
	return ShaderMove<Pixel>(s);
}
 ...
 */
template<typename Pixel>
inline ShaderMove<Pixel> ShaderSurface(Surface* s, int x, int y)
{
	return ShaderMove<Pixel>(s, x, y);
}
